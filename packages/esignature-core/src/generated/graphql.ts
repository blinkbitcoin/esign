...
export type CreateEnvelopeMutation = { createEnvelope: { envelopeId: string, signingUrl: string } };
...
export type GetSigningUrlMutation = { getSigningUrl: { signingUrl: string } };
