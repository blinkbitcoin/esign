...
<p>Line coverage aggregated over the workspaces that enforce 100% (the three publishable packages, the backend, and the tooling scripts). Demo apps are excluded. Click a workspace for its file-level report.</p>
